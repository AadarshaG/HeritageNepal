<!-- Start Slider Area -->
        <div class="slider__container slider--one bg__cat--3">
            <div class="slide__container slider__activation__wrap owl-carousel">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Luxor CHAIR</h1>
                                        <div class="cr__btn">
                                            <a href="{{url('product/luxor')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Kaleen Rugs</h1>
                                        <div class="cr__btn">
                                            <a href="{{url('product/kaleen')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <div class="cr__btn">
                                            <a href="{{url('product/grassia')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- End Single Slide --><!-- Start Single Slide -->
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        <h2>collection <?php echo date("Y"); ?></h2>
                                        <h1>Supreme Furnitures</h1>
                                        <div class="cr__btn">
                                            <a href="{{url('product/supreme')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <div class="cr__btn">
                                            <a href="{{url('product/artDeco')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <div class="cr__btn">
                                            <a href="{{url('product/floorMax')}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
